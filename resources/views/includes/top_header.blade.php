        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-header text-center">
                    <a class="navbar-brand color-black" href="{{route('dashboard')}}">
                        <!-- Logo icon --><b>
                            <!-- YURRIDEE Logo -->
                            <img src="{{asset('assets/images/logo.png')}}" alt="homepage" class="dark-logo thumb-md" />
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <form class="app-search d-none d-md-block d-lg-block">
                                <input type="text" class="form-control" placeholder="Search & enter as">
                            </form>
                        </li>
                    </ul>
                </div>
